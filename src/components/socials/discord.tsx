...
export const DiscordSocial = component$(() => {
  return (
    <a
      target='_blank'
      href='https://discord.gg/HPHqvT9NnH'
    ...
    >
      {/* ::discord svg */}
      <svg className='w-6 h-6 fill-current' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 48 48'>
