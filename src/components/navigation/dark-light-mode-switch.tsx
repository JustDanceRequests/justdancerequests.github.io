...
export const DarkLightModeSwitch = component$(() => {
  const themeContext = useContext(ThemeContext);
  return (
    <button
      class='text-gray-500 dark:text-gray-400 hover:bg-gray-300 dark:hover:bg-gray-700 bg-gray-200 dark:bg-gray-800 rounded-lg text-sm p-2.5'
      onClick$={() => {
